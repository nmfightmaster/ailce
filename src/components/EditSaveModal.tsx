  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 p-4">
      <div className="w-full max-w-lg rounded-xl border border-white/10 bg-zinc-900 p-4 text-zinc-100 shadow-2xl">
        <div className="mb-3">
          <h3 className="text-base font-semibold">Save Edit</h3>
          <p className="mt-1 text-xs text-zinc-400">Choose what to do after saving your change to this user message.</p>
        </div>
        ...
        <div className="space-y-2 text-sm">
          <button
            onClick={applyEditDoNothing}
            className="w-full rounded-md bg-white/10 px-3 py-2 text-left hover:bg-white/20"
          >
            <div className="font-medium">Do Nothing</div>
            <div className="text-xs text-zinc-400">Save the edit and keep all subsequent messages unchanged.</div>
          </button>

          <button
            onClick={applyEditTrim}
          ...
          >
            ...
            <div className="text-xs text-zinc-200">Save the edit, delete messages after it, and regenerate the assistant reply.</div>
          </button>
          ...
          <div className="rounded-md border border-white/10 bg-white/5 p-3">
            ...
            <div className="flex gap-2">
              <button
                onClick={() => applyEditBranch(branchTitle.trim() || undefined)}
